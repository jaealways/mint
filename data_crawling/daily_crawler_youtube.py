    ...
    def read_db(self):
        ...
        for x in list_db_music:
            for num_video_order in range(1, len(x)-3):
                ...
                if self.video_num > 0:
                    if self.video_num in [17, 159, 161, 176, 180, 188, 319, 358, 464, 539, 596, 597, 600, 632, 683, 696, 709, 789, 813, 878, 914, 931,
                                          ...
                                          6286, 6306, 6367, 6368, 6384, 6442, 6480, 6561, 6588, 6653, 6700, 6729, 7079, 7098, 7102, 7120, 7184, 7216, 7290, 7352, 7363,
