...
list_artist_mc = ['뮤직카우', '앤씨아', '견우', '이우', 'JBJ', '헤일로', 'NATURE', '이예준', '야다', 'AOA', '빅마마', '미교', '정동하',
                  ...
                  '웬디', '이소정', 'LambC', '조현아', '신용재', '이기광', '채정안', '이동은', '승희', '하하', '빅스타', '김정민', '러블리즈', '송민경']
...
list_artist_query = ['뮤직카우', '앤씨아', '견우 이지훈', '가수 이우', 'JBJ', '아이돌 헤일로', '아이돌 네이처', '이예준', '야다', 'AOA', '빅마마',
                     ...
                     '가수 The One 더원', '혼성그룹 샵', '가수 홍자', '가수 김현철', '가수에이스타일 지코', 'EXID', '가수 김민우', '황치열',
                     ...
                     '오마이걸 승희', '하하', '그룹 빅스타', '가수 김정민', '러블리즈', '가수 송민경']
