    ...
    def read_db(self):
        ...
        for x in list_db_music:
            for num_video_order in range(1, len(x)-3):
                ...
                if self.video_num > 0:
                    if self.video_num in [17, 161, 539, 596, 597, 600, 709, 789, 1586, 1845, 2413, 2514, 2671, 2849, 2889, 3328, 3812,
                                          3879, 4056, 4210, 4440, 4499, 4866, 4945, 5305, 5463, 6059, 6252, 6561, 7216, 7290, 7369, 7394, 7510, 7685, 7734,
                                          7824, 7989, 8098, 8170]:
                        # num = 8178까지
                        pass
                    else:
