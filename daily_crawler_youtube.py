            ...
            for num_video_order in range(1, len(x)-3):
                ...
                if self.video_num > 0:
                    if self.video_num in [17, 161, 176, 188, 319, 464, 539, 596, 597, 600, 683, 709, 789, 813, 878, 931,
                                          ...
                                          5133, 5164, 5305, 5433, 5463, 5649, 5766, 5804, 5809, 5939, 6015, 6059, 6252,
                                          6286, 6367, 6368, 6480, 6561, 6588, 6653, 6700, 7184, 7216, 7290, 7352, 7363,
                                          7369, 7394, 7510, 7660, 7685, 7734, 7824, 7989, 8098, 8170]:
                        # num = 8242까지
                        pass
                    else:
                        self.crawling_daily()
