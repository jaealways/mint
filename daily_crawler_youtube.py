    ...
    def read_db(self):
        ...
        for x in list_db_music:
            for num_video_order in range(1, len(x)-3):
                ...
                if self.video_num > 0:
                    if self.video_num in [17, 161, 176, 188, 539, 596, 597, 600, 709, 789, 1204, 1510, 1586, 1845, 1974, 2314, 2413, 2514, 2671, 2849, 2889, 3074, 3088, 3130, 3158, 3328, 3595, 3812,
                                          3879, 3905, 4008, 4056, 4210, 4288, 4440, 4499, 4538, 4866, 4945, 5133, 5305, 5463, 5766, 5804, 6059, 6252, 6368, 6561, 7184, 7216, 7290, 7352, 7363, 7369, 7394, 7510, 7685, 7734,
                                          7824, 7989, 8098, 8170]:
                        # num = 8200까지
                        pass
                    else:
