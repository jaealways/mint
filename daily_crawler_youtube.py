            ...
            for num_video_order in range(1, len(x)-3):
                ...
                if self.video_num > 0:
                    if self.video_num in [17, 161, 176, 188, 319, 464, 539, 596, 597, 600, 683, 709, 789, 813, 878, 931,
                                          1019, 1112, 1204, 1494, 1506, 1510, 1561, 1586, 1655, 1657, 1747, 1845, 1974, 2314, 2413, 2514,
                                          2671, 2764, 2826, 2849, 2889, 2934, 3007, 3033, 3046, 3067, 3074, 3088, 3130,
                                          3158, 3249, 3260, 3328, 3595, 3702, 3706, 3812, 3879, 3905, 3923, 4008, 4056, 4108, 4178,
                                          4184, 4210, 4288, 4378, 4440, 4482, 4485, 4499, 4509, 4538, 4866, 4874, 4892, 4945,
                                          5133, 5164, 5286, 5305, 5433, 5463, 5477, 5649, 5710, 5766, 5804, 5809, 5825, 5939, 6015, 6039, 6059, 6252,
                                          6286, 6306, 6367, 6368, 6442, 6480, 6561, 6588, 6653, 6700, 6729, 7120, 7184, 7216, 7290, 7352, 7363,
                                          7369, 7394, 7510, 7660, 7685, 7734, 7824, 7989, 8034, 8098, 8162, 8170]:
                        # num = 8259까지
                        pass
                    else:
                        self.crawling_daily()
