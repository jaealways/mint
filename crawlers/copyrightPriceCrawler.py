...
# 2. 처음 긁을때 2018-1 ~ 2022-1 까지 긁어와지는거까지 구현함
# 3. 새로 추가된 곡들에 대해 반응하도록
# 4. 이전에 코드 돌렸던 이후로 또 코드 돌릴 때 디비에 저장된 데이터 이후에 뮤카에 등록된 데이터부터 긁도록 설계해야함 ex) 2022-1 까지 저번에 긁어왔다면 나중에 코드돌릴때는 2022-2 ~ 긁어야
